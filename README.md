...
[![CRAN
status](https://www.r-pkg.org/badges/version/pkmapr)](https://cran.r-project.org/package=pkmapr)
...
- For census indicators from the Pakistan Population Census 2023, see
  [PakPC2023](https://cran.r-project.org/package=PakPC2023).
