...
Before opening an issue, check that you are running the latest CRAN release
(`install.packages("pkmapr")`) or the development version from GitHub. Then
...
Open an issue with the label `enhancement` and describe what you would like
to see and why it would be useful.
