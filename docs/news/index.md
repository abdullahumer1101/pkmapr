...
- Added `palette` and `breaks` arguments to
  [`pk_map()`](https://abdullahumer1101.github.io/pkmapr/reference/pk_map.md)
  for control over choropleth colour scales and legend break points.
- Added `gains`style = “idw” to
  [`pk_neighbors()`](https://abdullahumer1101.github.io/pkmapr/reference/pk_neighbors.md)
  for inverse distance weights.
- Added cross-reference to PakPC2023 (Yaseen et al.) for census
  indicator data.
