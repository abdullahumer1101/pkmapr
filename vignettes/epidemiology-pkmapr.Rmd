---
title: "Epidemiological Analysis with pkmapr"
...
`pak_neighbors()` handles this automatically.
...
The Line of Control creates analytical ambiguity. `pak_neighbors()` makes your decision explicit:
